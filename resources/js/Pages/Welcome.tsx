                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                            <div className="flex lg:justify-center lg:col-start-2">
                                <svg className="h-12 w-auto text-white lg:h-16 lg:text-[#FF2D20]" viewBox="0 0 62 65"
                        ...
                        <main className="mt-6">
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                    ...
                                    <div className="relative flex items-center gap-6 lg:items-end">
                                        <div id="docs-card-content" className="flex items-start gap-6 lg:flex-col">
                                            <div
                                                ...
                                                <svg className="size-5 sm:size-6" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <svg className="size-6 shrink-0 stroke-[#FF2D20]"
                                ...
                                >
                                    ...
                                    <svg className="size-6 shrink-0 self-center stroke-[#FF2D20]"
                                         xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                         strokeWidth="1.5">
                                        <path strokeLinecap="round" strokeLinejoin="round"
                                              d="M4.5 12h15m0 0l-6.75-6.75M19.5 12l-6.75 6.75"/>
                                ...
                                >
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        <h2 className="text-xl font-semibold text-black dark:text-white">Laravel
                                            News</h2>
                                ...
                                <div
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            ...
                                            you take your projects to the next level. Pair them with powerful open
